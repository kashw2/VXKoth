...
if(document.getElementById("grid-container")) {
    ...
    for(var i = 0; i < document.getElementsByTagName("h4").length; i++) {
        ...
        document.getElementsByTagName("h4")[i].style.color = "#000000";
    ...
    for(var i = 0; i < document.getElementsByTagName("h5").length; i++) {
        ...
        document.getElementsByTagName("h5")[i].style.color = "#000000";
    ...
    for(var i = 0; i < document.getElementsByTagName("h6").length; i++) {
        ...
        document.getElementsByTagName("h6")[i].style.color = "#000000";
    ...
    for(var i = 0; i < document.getElementsByTagName("tr").length; i++) {
        ...
        document.getElementsByTagName("tr")[i].style.color = "#000000";
    ...
    document.getElementById("grid-data").style.borderTop = "1px solid #000000";
